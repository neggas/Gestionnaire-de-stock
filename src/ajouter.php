							...
							<tr>
								...
								<td>
									<div class="error_messages">
										<?php if (!empty($error_messages['file'])) {
					...
					<div class="content-input">
						<table>
							<tr>
								...
								<td>
									<div class="error_messages">
										<?php if (!empty($error_messages['name'])) {
					...
					<div class="content-input">
						<table>
							<tr>
								...
								<td>
									<div class="error_messages">
										<?php if (!empty($error_messages['ref'])) {
											echo $error_messages['ref'];
										} ?>
									</div>
								</td>
							</tr>
						</table>
						<input value="<?php if (isset($_POST['ref'])) {
											echo $_POST['ref'];
										} ?>" type="text" name="ref" placeholder="Ref">
					</div>
					<div class="content-input">
						<table>
							<tr>
								...
								<td>
									<div class="error_messages">
										<?php if (!empty($error_messages['price_ttc'])) {
											echo $error_messages['price_ttc'];
										} ?>
									</div>
								</td>
							</tr>
						</table>
						<input value="<?php if (isset($_POST['price_ttc'])) {
											echo $_POST['price_ttc'];
										} ?>" type="text" name="price_ttc" placeholder="Pric TTC">
					</div>
					<div class="content-input">
						<table>
							<tr>
								...
								<td>
									<div class="error_messages">
										<?php if (!empty($error_messages['price_ht'])) {
											echo $error_messages['price_ht'];
										} ?>
									</div>
								</td>
							</tr>
						</table>
						<input value="<?php if (isset($_POST['price_ht'])) {
											echo $_POST['price_ht'];
										} ?>" type="text" name="price_ht" placeholder="Prix HT">
					</div>
					<div class="content-input">
						<table>
							<tr>
								...
								<td>
									<div class="error_messages">
										<?php if (!empty($error_messages['amount'])) {
											echo $error_messages['amount'];
										} ?>
									</div>
								</td>
							</tr>
						</table>
						<input value="<?php if (isset($_POST['amount'])) {
											echo $_POST['amount'];
										} ?>" type="text" name="amount" placeholder="Quantité">
					</div>
					<div class="content-input">
						<table>
							<tr>
						...
						<textarea value="<?php if (isset($_POST[''])) {
												echo $_POST[''];
											} ?>" name="notes" placeholder="Description"></textarea>
					</div>
				</div>
